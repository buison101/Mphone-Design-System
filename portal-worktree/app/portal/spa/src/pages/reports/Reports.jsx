...
const initialFilters = { from: initialFrom, to: today };
...
export default function Reports() {
  ...
  const { data, error, isLoading, isValidating, refresh } = useAnalytics(REPORTS_URL, { ...filters, report });
  ...
  return (
    <Stack sx={{ gap: 2.5 }}>
      <PageHeader title={<FormattedMessage id="reports.title" />} description={<FormattedMessage id="reports.description" />} />
      <MainCard content={false}>
