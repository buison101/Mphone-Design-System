  ...
  return (
    <Grid container spacing={2.5}>
      ...
      <Grid size={{ xs: 12, lg: 4 }}>
        <MainCard title={intl.formatMessage({ id: 'overview.summary' })}>
          <Stack sx={{ gap: 2 }}>
            <Stack sx={{ gap: 0.5 }}>
              <Typography variant="h6" sx={{ color: 'text.secondary' }}>
                <FormattedMessage id="overview.answerRate" />
              </Typography>
              <Typography variant="h3">{answerRate === null ? '—' : `${answerRate}%`}</Typography>
            </Stack>
            ...
            <Stack direction="row" sx={{ justifyContent: 'space-between' }}>
              <Typography variant="body2" sx={{ color: 'text.secondary' }}>
                <FormattedMessage id="overview.answered" />
              </Typography>
              <Typography variant="subtitle2">{totals?.answered ?? '—'}</Typography>
            </Stack>
      ...
      <Grid size={{ xs: 12, lg: 6 }}>
        <MainCard title={intl.formatMessage({ id: 'overview.duration' })}>
          <Stack sx={{ minHeight: 250, justifyContent: 'center', gap: 2.5 }}>
            <Stack sx={{ gap: 0.5 }}>
              <Typography variant="h6" sx={{ color: 'text.secondary' }}>
      ...
      <Grid size={12}>
        <MainCard title={intl.formatMessage({ id: 'overview.recent' })} content={false}>
          <DataTableContainer ariaLabel={intl.formatMessage({ id: 'overview.recent' })}>
