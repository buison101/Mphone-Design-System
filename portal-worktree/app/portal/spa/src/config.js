...
// not implemented on the server yet; the webphone falls back to its demo driver
// until this answers. The expected payload is in docs/13-app-screen-map.md.
export const WEBPHONE_URL = '/app/portal/service/webphone.php';
