      ...
      default:
        return (
          <Typography key={item.id} variant="h6" sx={{ color: 'error.main', textAlign: 'center' }}>
            <FormattedMessage id="nav.error.collapseOrItem" />
          </Typography>
        );
    }
  });
      ...
      {state.menuOrientation !== MenuOrientation.HORIZONTAL || downLG ? (
        <>
          ...
          >
            ...
            {(drawerOpen || (!drawerOpen && level !== 1)) && (
              <ListItemText
                primary={
                  <Typography variant="h6" sx={{ color: selected === menu.id || anchorEl ? 'primary.main' : textColor }}>
        ...
        >
          <Box onClick={handlerIconLink} sx={FlexBox}>
            ...
            <ListItemText
              primary={
                <Typography variant="body1" sx={{ color: 'inherit', my: 'auto' }}>
                  <FormattedMessage id={menu.title} />
                </Typography>
              }
            />
