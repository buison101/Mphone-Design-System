              ...
              >
                <Stack sx={{ gap: 1.25, alignItems: 'center' }}>
                  ...
                  <Typography variant="caption">
                    <FormattedMessage id="header.customization.mode.light" />
                  </Typography>
                </Stack>
              </MainCard>
            }
            ...
            label={
              ...
              >
                <Stack sx={{ gap: 1.25, alignItems: 'center' }}>
                  ...
                  />
                  <Typography variant="caption">
                    <FormattedMessage id="header.customization.mode.dark" />
                  </Typography>
                </Stack>
              </MainCard>
            }
            ...
            label={
              ...
              >
                <Stack sx={{ gap: 1.25, alignItems: 'center' }}>
                  ...
                  />
                  <Typography variant="caption">
                    <FormattedMessage id="header.customization.mode.system" />
                  </Typography>
                </Stack>
              </MainCard>
            }
