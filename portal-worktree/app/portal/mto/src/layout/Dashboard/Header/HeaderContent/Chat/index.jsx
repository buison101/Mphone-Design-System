...
export default function Chat() {
  ...
  return (
    <>
      <Box sx={{ flexShrink: 0 }}>
        <Tooltip title={intl.formatMessage({ id: 'header.chat.title' })}>
          <IconButton
            color="secondary"
            variant="light"
            sx={(theme) => ({
            ...
            aria-label={intl.formatMessage({ id: 'header.chat.open' })}
        ...
        {open && (
          <MainCard
            ...
            secondary={
              <>
                {selectedUser === null && (
                  <Link href="#" underline="hover" sx={{ typography: 'caption', textTransform: 'none' }}>
