...
const PAGINATION_COLORS = ['primary', 'secondary', 'error', 'info', 'success', 'warning'];
...
function generateColorVariants(theme, variant) {
  return PAGINATION_COLORS.reduce((acc, color) => {
