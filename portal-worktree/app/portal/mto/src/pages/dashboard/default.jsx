    ...
    <Grid container rowSpacing={4.5} columnSpacing={2.75}>
      ...
      <Grid sx={{ mb: -2.25 }} size={12}>
        <Typography variant="h5">
          <FormattedMessage id="nav.dashboard.dashboard" />
        </Typography>
      </Grid>
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce
          title={intl.formatMessage({ id: 'dashboard.kpi.pageViews' })}
          count="4,42,236"
          percentage={59.3}
          extra="35,000"
        />
      ...
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce title={intl.formatMessage({ id: 'dashboard.kpi.users' })} count="78,250" percentage={70.5} extra="8,900" />
      </Grid>
      <Grid size={{ xs: 12, sm: 6, lg: 3 }}>
        <AnalyticEcommerce
          title={intl.formatMessage({ id: 'dashboard.kpi.orders' })}
          count="18,800"
          percentage={27.4}
          isLoss
          color="warning"
      ...
      <Grid size={{ xs: 12, md: 5, lg: 4 }}>
        <Grid container sx={{ alignItems: 'center', justifyContent: 'space-between' }}>
          <Grid>
            <Typography variant="h5">
              <FormattedMessage id="dashboard.transactionHistory" />
            </Typography>
          </Grid>
          <Grid />
        </Grid>
          ...
          >
              ...
              <ListItemText
                primary={
                  <Typography variant="subtitle1">
                    <FormattedMessage id="dashboard.transaction.order" values={{ ref: '#002434' }} />
                  </Typography>
                }
            ...
            >
              ...
              <ListItemText
                primary={
                  <Typography variant="subtitle1">
                    <FormattedMessage id="dashboard.transaction.order" values={{ ref: '#984947' }} />
                  </Typography>
                }
            ...
            >
              ...
              <ListItemText
                primary={
                  <Typography variant="subtitle1">
                    <FormattedMessage id="dashboard.transaction.order" values={{ ref: '#988784' }} />
                  </Typography>
                }
              ...
              <Grid>
                <Stack>
                  <Typography variant="h5" noWrap>
                    <FormattedMessage id="dashboard.support.title" />
                  </Typography>
                  <Typography variant="caption" sx={{ color: 'secondary.main' }} noWrap>
                    <FormattedMessage id="dashboard.support.replyTime" />
                  </Typography>
                </Stack>
              </Grid>
              <Grid>
                <AvatarGroup sx={{ '& .MuiAvatar-root': { width: 32, height: 32 } }}>
                  <Avatar alt={intl.formatMessage({ id: 'common.avatarAlt' })} src={avatar1} />
                  <Avatar alt={intl.formatMessage({ id: 'common.avatarAlt' })} src={avatar2} />
                  <Avatar alt={intl.formatMessage({ id: 'common.avatarAlt' })} src={avatar3} />
                  <Avatar alt={intl.formatMessage({ id: 'common.avatarAlt' })} src={avatar4} />
                </AvatarGroup>
              </Grid>
            </Grid>
            <Button size="small" variant="contained" sx={{ textTransform: 'none' }}>
              <FormattedMessage id="dashboard.support.action" />
            </Button>
          </Stack>
        </MainCard>
      </Grid>
