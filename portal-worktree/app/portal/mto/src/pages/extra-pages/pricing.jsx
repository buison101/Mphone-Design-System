        ...
        <MainCard>
          <Stack sx={{ gap: 2, width: { xs: '95%', sm: '70%' } }}>
            <Stack direction="row" sx={{ gap: 1.5, alignItems: 'center' }}>
              <Typography variant="subtitle1" sx={{ color: timePeriod ? 'text.secondary' : 'text.primary' }}>
                Billed Yearly
              </Typography>
              <Switch
                checked={timePeriod}
              ...
              />
              <Typography variant="subtitle1" sx={{ color: timePeriod ? 'text.primary' : 'text.secondary' }}>
                Billed Monthly
              </Typography>
            </Stack>
              ...
              <Grid container spacing={3}>
                <Grid size={12}>
                  <Stack direction="row" sx={{ gap: 2, alignItems: 'center', textAlign: 'center' }}>
                    <Box sx={{ height: 36, '& svg': { height: 1 } }}>{plan.icon}</Box>
