        ...
        >
          <Stack>
            <Typography variant="h5">
              <FormattedMessage id="dashboard.reader.title" />
            </Typography>
            <Typography variant="caption" sx={{ maxWidth: '55%', pt: 1 }}>
              <FormattedMessage id="dashboard.reader.body" />
            </Typography>
          ...
          <MainCard sx={{ borderRadius: { xs: 2, sm: '0px 8px 8px 0px' }, height: '100%', mt: { xs: 2.5, sm: 0 } }}>
            <Grid container spacing={3}>
              <Grid size={12}>
                <Stack>
                  <Typography>
                    <FormattedMessage id="dashboard.reader.item" />
                  </Typography>
                  <Typography sx={{ color: 'text.secondary', pt: 1 }}>
                    <FormattedMessage id="dashboard.reader.updated" values={{ date: '05/11/2025' }} />
                  </Typography>
                    ...
                    <Tooltip
                      ...
                      title={
                        <AvatarGroup max={10}>
                          ...
                          <Avatar alt={intl.formatMessage({ id: 'common.avatarAlt' })} src={avatar5} />
                          <Avatar alt={intl.formatMessage({ id: 'common.avatarAlt' })} src={avatar6} />
                        </AvatarGroup>
                      }
                    >
                      <AvatarGroup
              ...
              <Grid size={12}>
                <Typography variant="caption" sx={{ color: 'secondary.main' }}>
                  <FormattedMessage id="dashboard.reader.note" />
                </Typography>
              </Grid>
            </Grid>
          </MainCard>
