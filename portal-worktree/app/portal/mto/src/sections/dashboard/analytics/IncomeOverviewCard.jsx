          ...
          <Grid size={{ xs: 12, sm: 6 }}>
            <Stack sx={{ alignItems: { xs: 'center', sm: 'flex-start' }, ml: { xs: 0, sm: 2 }, mt: 3 }}>
              ...
              <Typography sx={{ color: 'text.secondary', display: 'block' }}>
                <FormattedMessage id="dashboard.income.compare" values={{ range: '01/12/2021 – 08/01/2022' }} />
              </Typography>
            </Stack>
          </Grid>
          <Grid size={{ xs: 12, sm: 6 }}>
            ...
            >
              <ToggleButtonGroup exclusive onChange={handleChange} size="small" value={slot}>
                <ToggleButton disabled={slot === 'week'} value="week" sx={{ px: 2, py: 0.5 }}>
                  <FormattedMessage id="common.period.week" />
                </ToggleButton>
                <ToggleButton disabled={slot === 'month'} value="month" sx={{ px: 2, py: 0.5 }}>
                  <FormattedMessage id="common.period.month" />
                </ToggleButton>
              </ToggleButtonGroup>
              <Select value={quantity} onChange={handleQuantity} size="small">
                <MenuItem value="By volume">
                  <FormattedMessage id="dashboard.income.byVolume" />
                </MenuItem>
                <MenuItem value="By margin">
                  <FormattedMessage id="dashboard.income.byMargin" />
                </MenuItem>
                <MenuItem value="By sales">
                  <FormattedMessage id="dashboard.income.bySales" />
                </MenuItem>
              </Select>
              <IconButton
                color="secondary"
