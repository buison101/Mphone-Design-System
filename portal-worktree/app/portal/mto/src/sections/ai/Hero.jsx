          ...
          <Stack sx={{ alignItems: 'center', gap: 2.5 }}>
            ...
            >
              ...
              >
                ...
                <span>Not Harder with Premade</span>
                <Box component="span" sx={{ color: 'primary.main' }}>
                  <span> Prompts</span>
                </Box>
              </Typography>
            ...
            >
              <Divider sx={{ borderColor: withAlpha(theme.vars.palette.primary.main, 0.5), minWidth: 280, width: '12%', my: 1 }} />
            </motion.div>
                    ...
                    slotProps={{
                      label: {
                        sx: {
                          ...
                          typography: 'caption2',
                          color: 'secondary.light',
                          ...theme.applyStyles('dark', { color: 'secondary.main' })
                        }
                      }
                    }}
                    sx={{ height: 32, px: 1, borderColor: withAlpha(theme.vars.palette.secondary.main, 0.4) }}
                  />
                </motion.div>
              ))}
            </Stack>
                    ...
                    >
                      ...
                      <Box
                        sx={{
                          ...
                          borderRadius: 3,
                          overflow: 'hidden',
                          border: `1.5px solid ${withAlpha(theme.vars.palette.primary.main, 0.7)}`,
                          background: 'linear-gradient(160deg, #0a1628 0%, #0f2245 55%, #0d1b35 100%)',
                          boxShadow: `0 0 48px ${withAlpha(theme.vars.palette.primary.main, 0.2)}, 0 24px 60px rgba(0,0,0,0.55)`,
                          ...
                          '&::before': {
                            ...
                            height: 160,
                            borderRadius: '50%',
                            background: withAlpha(theme.vars.palette.primary.main, 0.12),
                            filter: 'blur(30px)',
                            pointerEvents: 'none'
                          },
                          ...
                          >
                            <Stack direction="row" sx={{ alignItems: 'baseline', justifyContent: 'center', gap: 1 }}>
                              <Typography
                                component="span"
                                sx={{
                                  color: withAlpha(theme.palette.common.white, 0.5),
                                  fontSize: '1.5rem',
                              ...
                              <Typography
                                component="span"
                                sx={{ color: theme.vars.palette.primary.dark, fontWeight: 700, fontSize: '2rem', lineHeight: 1 }}
                              >
                                Free
                              </Typography>
                            </Stack>
                            ...
                            {proFeatures.map((feat, i) => (
                              ...
                              >
                                <ListItemIcon sx={{ minWidth: 28, color: 'success.main' }}>
                                  <CheckOutlined style={{ color: 'inherit', fontSize: 13 }} />
                                </ListItemIcon>
                                <ListItemText
                                  primary={feat}
