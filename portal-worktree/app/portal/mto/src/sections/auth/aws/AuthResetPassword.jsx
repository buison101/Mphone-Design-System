            ...
            <Grid container spacing={3}>
              <Grid size={12}>
                <Stack sx={{ gap: 1 }}>
                  ...
                  <InputLabel htmlFor="verification-code">
              ...
              <Grid size={12}>
                <Stack sx={{ gap: 1 }}>
                  <InputLabel htmlFor="password-reset">
                    <FormattedMessage id="auth.reset.newPassword" />
                  </InputLabel>
                  <OutlinedInput
                    fullWidth
              ...
              <Grid size={12}>
                <Stack direction="row" sx={{ alignItems: 'baseline', justifyContent: 'space-between' }}>
                  <Typography>
                    <FormattedMessage id="auth.code.noEmail" />
                  </Typography>
                  <Typography
                    component={Link}
                    ...
                    color="primary"
                  >
                    <FormattedMessage id="auth.code.resend" />
                  </Typography>
                </Stack>
              </Grid>
            </Grid>
