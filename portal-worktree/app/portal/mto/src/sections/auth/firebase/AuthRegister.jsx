              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Stack sx={{ gap: 1 }}>
                  ...
                  <OutlinedInput
                    ...
                    placeholder={intl.formatMessage({ id: 'auth.placeholder.firstName' })}
                    fullWidth
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                <Stack sx={{ gap: 1 }}>
                  ...
                  <OutlinedInput
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    placeholder={intl.formatMessage({ id: 'auth.placeholder.lastName' })}
                  />
                </Stack>
              ...
              <Grid size={12}>
                <Stack sx={{ gap: 1 }}>
                  <InputLabel htmlFor="company-signup">
                    <FormattedMessage id="auth.field.company" />
                  </InputLabel>
                  <OutlinedInput
                    fullWidth
                    ...
                    onBlur={handleBlur}
                    onChange={handleChange}
                    placeholder={intl.formatMessage({ id: 'auth.placeholder.company' })}
                  />
                </Stack>
              ...
              <Grid size={12}>
                <Stack sx={{ gap: 1 }}>
                  <InputLabel htmlFor="password-signup">
                    <FormattedMessage id="auth.field.password" />
                  </InputLabel>
                  <OutlinedInput
                    fullWidth
                    ...
                    endAdornment={
                      <InputAdornment position="end">
                        <IconButton
                          aria-label={intl.formatMessage({ id: 'auth.togglePassword' })}
              ...
              <Grid size={12}>
                <Divider>
                  <Typography variant="caption">
                    <FormattedMessage id="auth.signUpWith" />
                  </Typography>
                </Divider>
              </Grid>
              <Grid size={12}>
