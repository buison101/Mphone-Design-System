                ...
                <Grid size={12}>
                  ...
                  <Stack sx={{ gap: 2.5, alignItems: 'center' }}>
                    ...
                    <Stack sx={{ gap: 0.5, alignItems: 'center' }}>
                      ...
                      <Typography sx={{ color: 'secondary.main' }}>Project Manager</Typography>
                    </Stack>
                  </Stack>
                </Grid>
                <Grid size={12}>
                ...
                <Grid size={12}>
                  <Stack direction="row" sx={{ alignItems: 'center', justifyContent: 'space-around' }}>
                    <Stack sx={{ gap: 0.5, alignItems: 'center' }}>
                      ...
                      <Typography sx={{ color: 'secondary.main' }}>Post</Typography>
                    </Stack>
                    <Divider orientation="vertical" flexItem />
                    <Stack sx={{ gap: 0.5, alignItems: 'center' }}>
                      <Typography variant="h5">40</Typography>
                      <Typography sx={{ color: 'secondary.main' }}>Project</Typography>
                    </Stack>
                    <Divider orientation="vertical" flexItem />
                    <Stack sx={{ gap: 0.5, alignItems: 'center' }}>
                      <Typography variant="h5">4.5K</Typography>
                      <Typography sx={{ color: 'secondary.main' }}>Members</Typography>
                    </Stack>
                  </Stack>
                </Grid>
                <Grid size={12}>
          ...
          <Grid size={12}>
            <MainCard title="Skills">
              <Grid container spacing={1.25}>
                <Grid size={6}>
                  <Typography sx={{ color: 'secondary.main' }}>Junior</Typography>
                </Grid>
                <Grid size={6}>
                  <LinearWithLabel value={30} />
                </Grid>
                <Grid size={6}>
                  <Typography sx={{ color: 'secondary.main' }}>UX Reseacher</Typography>
                </Grid>
                <Grid size={6}>
                  <LinearWithLabel value={80} />
                </Grid>
                <Grid size={6}>
                  <Typography sx={{ color: 'secondary.main' }}>Wordpress</Typography>
                </Grid>
                <Grid size={6}>
                  <LinearWithLabel value={90} />
                </Grid>
                <Grid size={6}>
                  <Typography sx={{ color: 'secondary.main' }}>HTML</Typography>
                </Grid>
                <Grid size={6}>
                  <LinearWithLabel value={30} />
                </Grid>
                <Grid size={6}>
                  <Typography sx={{ color: 'secondary.main' }}>Graphic Design</Typography>
                </Grid>
                <Grid size={6}>
                  <LinearWithLabel value={95} />
                </Grid>
                <Grid size={6}>
                  <Typography sx={{ color: 'secondary.main' }}>Code Style</Typography>
                </Grid>
                <Grid size={6}>
              ...
              <List sx={{ py: 0 }}>
                <ListItem divider={!downMD}>
                  <Grid container spacing={3} sx={{ width: 1 }}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Full Name</Typography>
                        <Typography>Anshan Handgun</Typography>
                      </Stack>
                    </Grid>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Father Name</Typography>
                ...
                <ListItem divider={!downMD}>
                  <Grid container spacing={3} sx={{ width: 1 }}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Country</Typography>
                ...
                <ListItem divider={!downMD}>
                  <Grid container spacing={3} sx={{ width: 1 }}>
                    ...
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Zip Code</Typography>
              ...
              <List sx={{ py: 0 }}>
                <ListItem divider>
                  <Grid container spacing={{ xs: 0.5, md: 3 }} sx={{ width: 1 }}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Master Degree (Year)</Typography>
                        <Typography>2014-2017</Typography>
                      </Stack>
                    </Grid>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Institute</Typography>
                ...
                <ListItem divider>
                  <Grid container spacing={{ xs: 0.5, md: 3 }} sx={{ width: 1 }}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Bachelor (Year)</Typography>
                ...
                <ListItem>
                  <Grid container spacing={{ xs: 0.5, md: 3 }} sx={{ width: 1 }}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>School (Year)</Typography>
              ...
              <List sx={{ py: 0 }}>
                <ListItem divider>
                  <Grid container spacing={{ xs: 0.5, md: 3 }} sx={{ width: 1 }}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Senior UI/UX designer (Year)</Typography>
                        <Typography>2019-Current</Typography>
                      </Stack>
                    </Grid>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Job Responsibility</Typography>
                        <Typography>
                ...
                <ListItem>
                  <Grid container spacing={{ xs: 0.5, md: 3 }} sx={{ width: 1 }}>
                    <Grid size={{ xs: 12, md: 6 }}>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Trainee cum Project Manager (Year)</Typography>
