            ...
            <List sx={{ width: 1, p: 0 }}>
              ...
              >
                ...
                <ListItemText
                  ...
                  secondary={<Typography sx={{ color: 'secondary.main' }}>{customer.role}</Typography>}
                />
              </ListItem>
            </List>
          </DialogTitle>
                ...
                <Grid size={{ xs: 12, sm: 4, xl: 3 }}>
                  <MainCard>
                    <Stack sx={{ gap: 2 }}>
                      ...
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Contact</Typography>
                        <Typography>
                          <PatternFormat displayType="text" format="+1 (###) ###-####" mask="_" defaultValue={customer.contact} />
                        </Typography>
                      </Stack>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Location</Typography>
                        <Typography> {customer.country} </Typography>
                      </Stack>
                      <Stack sx={{ gap: 0.5 }}>
                        <Typography sx={{ color: 'secondary.main' }}>Website</Typography>
