        ...
        <Grid container spacing={3}>
          <Grid size={12}>
            <Tabs
              ...
              sx={{ '& .MuiButtonBase-root + .MuiButtonBase-root': { ml: 2 } }}
            >
              {getTabsOption().map((tab, index) => (
                <StyledTab
                  value={index}
                  cart={cart}
                  ...
                  label={
                    <Grid container>
                      <Stack direction="row" sx={{ gap: 1, alignItems: 'center' }}>
                        ...
                        <Typography sx={{ color: index > cart.step ? 'text.secondary' : 'inherit' }}>{tab.label}</Typography>
                      </Stack>
                    </Grid>
                  }
                />
