...
function ArrowUp({ currentSlide, slideCount, sx, ...props }) {
...
function ArrowDown({ currentSlide, slideCount, sx, ...props }) {
  const downMD = useMediaQuery((theme) => theme.breakpoints.down('md'));
  ...
  return (
    <Grid container spacing={0.5}>
      <Grid size={{ xs: 12, md: 10, lg: 9 }}>
        ...
        >
          <TransformWrapper initialScale={1} smooth={true} wheel={{ step: 0.003 }}>
...
ArrowUp.propTypes = { currentSlide: PropTypes.any, slideCount: PropTypes.any, sx: PropTypes.any, props: PropTypes.any };

ArrowDown.propTypes = { currentSlide: PropTypes.any, slideCount: PropTypes.any, sx: PropTypes.any, props: PropTypes.any };
