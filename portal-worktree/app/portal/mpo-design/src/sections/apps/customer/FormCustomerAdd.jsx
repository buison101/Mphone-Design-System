              ...
              <Grid container spacing={3}>
                ...
                <Grid size={{ xs: 12, md: 8 }}>
                  <Grid container spacing={3}>
                        ...
                        <FormControl fullWidth>
                          <Select
                            ...
                            renderValue={(selected) => {
                              ...
                              const selectedStatus = getAllStatus().filter((item) => item.value === Number(selected));
                              return (
                    ...
                    <Grid size={12}>
                      <Stack sx={{ gap: 1 }}>
                        <InputLabel htmlFor="customer-getSkills()">Skills</InputLabel>
                        <Autocomplete
                          multiple
                          fullWidth
                          id="customer-getSkills()"
                          options={getSkills()}
                          {...getFieldProps('getSkills()')}
                          getOptionLabel={(label) => label}
                          onChange={(event, newValue) => {
                            setFieldValue('getSkills()', newValue);
                          }}
