                ...
                <List sx={{ p: 0, overflow: 'hidden', '& .MuiListItem-root': { px: 0, py: 0.5 } }}>
                  <ListItem sx={{ alignItems: 'center' }}>
                    ...
                    <ListItemText
                      ...
                      slotProps={{
                        primary: { sx: { color: 'secondary.main', width: 'auto', overflow: 'hidden', textOverflow: 'ellipsis' } }
                      }}
                    />
                  </ListItem>
                  <ListItem sx={{ alignItems: 'center' }}>
                    ...
                    <ListItemText
                      slotProps={{ primary: { sx: { width: 'auto', overflow: 'hidden', textOverflow: 'ellipsis' } } }}
                      primary={
                        <Typography sx={{ color: 'secondary.main', whiteSpace: 'nowrap' }}>
              ...
              <Grid size={6}>
                <List sx={{ p: 0, overflow: 'hidden', '& .MuiListItem-root': { px: 0, py: 0.5 } }}>
                  <ListItem sx={{ alignItems: 'center' }}>
                    ...
                    <ListItemText primary={<Typography sx={{ color: 'secondary.main' }}>{customer.country}</Typography>} />
                  </ListItem>
                  <ListItem sx={{ alignItems: 'center' }}>
                    <ListItemIcon>
                      <LinkOutlined />
