          ...
          <Box sx={{ pb: 2.5 }}>
            <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ justifyContent: 'space-between' }}>
              <Box sx={{ pt: 2.5 }}>
                ...
                <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.invoice_id}</Typography>
              </Box>
                    ...
                    <Grid container direction="row">
                      <Grid size={{ md: 8 }}>
                        ...
                        <FormControl sx={{ width: '100%' }}>
                          ...
                          <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.cashierInfo.address}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.cashierInfo.phone}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.cashierInfo.email}</Typography>
                        </FormControl>
                      </Grid>
                    </Grid>
                  </Box>
                    ...
                    <Grid container direction="row">
                      <Grid size={{ md: 8 }}>
                        ...
                        <FormControl sx={{ width: '100%' }}>
                          ...
                          <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.customerInfo.address}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.customerInfo.phone}</Typography>
                          <Typography sx={{ color: 'secondary.main' }}>{invoiceInfo.customerInfo.email}</Typography>
                        </FormControl>
                      </Grid>
                    </Grid>
                  </Box>
