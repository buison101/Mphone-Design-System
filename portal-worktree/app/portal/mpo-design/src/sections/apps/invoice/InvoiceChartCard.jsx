...
import { BarPlot, ChartsXAxis, ChartsYAxis, ChartsTooltip, LineChart, LinePlot, MarkPlot, barClasses } from '@mui/x-charts';
    ...
    <MainCard border={false}>
      ...
      <Box sx={{ width: 1 }}>
        <LineChart
          ...
          dataset={getDatasets()[activeChart].data}
          height={274}
          margin={{ top: 50, right: 20, left: -15, bottom: -5 }}
          sx={{ [`& [data-series="teamA"] .${barClasses.element}`]: { fill: "url('#barGradient')" } }}
        >
          <BarPlot />
          <LinePlot />
          <MarkPlot />
