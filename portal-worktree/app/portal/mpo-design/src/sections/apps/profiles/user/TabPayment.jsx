...
// Hoisted into a function so the cardholder names are rebuilt on every render.
// As a module-scope constant this was evaluated once on import, which froze the
...
export default function TabPayment() {
  const [cards] = useState(getPaymentCards());
