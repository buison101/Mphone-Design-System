...
const getSteps = () => [
  ...
  },
  {
    ...
    description: 'Select prompt from our library based on your need.'
  },
  {
    title: 'Now Your Model Starts Working',
    description:
...
function WorkflowTimelineItem({ item, index, count }) {
  ...
  return (
    ...
    >
      <TimelineOppositeContent
        ...
        variant="body2"
        sx={{ color: 'secondary.lighter', height: 1, alignSelf: 'center', display: { xs: 'none', md: 'block' } }}
      ></TimelineOppositeContent>
          ...
          <Grid size={{ xs: 12, md: 8, lg: 6 }}>
            ...
            >
              <SectionTypeset
                ...
                headingProps={{ sx: { color: 'white' } }}
                descriptionProps={{ sx: { color: 'secondary.main' } }}
              />
            </motion.div>
          </Grid>
          <Grid size={{ xs: 12 }}>
...
WorkflowTimelineItem.propTypes = { item: PropTypes.any, index: PropTypes.number, count: PropTypes.number };
