...
const getFaqData = () => ({
  ...
  faqList: [
    ...
    {
      question: 'Does Mantis support JavaScript?',
      answer: <>Yes. Mantis includes full JavaScript support out of the box and smoother development.</>
    },
    {
    ...
    {
      question: 'How accurate are AI-powered suggestions?',
      answer: <>AI-powered suggestions are provided to speed up development workflows. Please validate outputs before production use.</>
    },
    {
...
export default function FaqPage() {
  ...
  return (
    <Grid
      container
      spacing={12}
      sx={(theme) => ({ justifyContent: 'center', alignItems: 'center', ...theme.mixins.toolbar, my: { xs: 6, lg: 12 } })}
    >
