...
export default function Landing() {
  ...
  const colorOptions = useMemo(() => {
    ...
    return [
      ...
      { id: 'mphone3', primary: isDark ? '#1E8AFF' : '#0071EC' },
      { id: 'mphone4', primary: isDark ? '#0064C8' : '#0071EC' },
      { id: 'mphone5', primary: isDark ? '#1E8AFF' : '#0071EC' },
      { id: 'mphone6', primary: isDark ? '#1E8AFF' : '#0071EC' },
