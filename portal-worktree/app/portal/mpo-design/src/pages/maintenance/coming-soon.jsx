  ...
  return (
    <Stack sx={{ gap: 4, minHeight: '100vh', py: 2, alignItems: 'center', justifyContent: 'center' }}>
      <Stack sx={{ gap: 1, alignItems: 'center', justifyContent: 'center' }}>
        ...
        <Typography sx={{ color: 'text.secondary', textAlign: 'center' }}>Something new is on its way</Typography>
      </Stack>
      ...
      <Box sx={{ width: { xs: 340, md: '40%', lg: '30%' } }}>
        <Stack sx={{ gap: 2, mt: 2 }}>
          <Typography sx={{ color: 'text.secondary', textAlign: 'center' }}>Be the first to be notified when Mantis launches.</Typography>
