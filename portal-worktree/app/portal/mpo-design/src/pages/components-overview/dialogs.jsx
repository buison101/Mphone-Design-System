...
export default function Dialogs() {
  const basicDialogCodeString = `// SimpleDialog.jsx
...
<Dialog onClose={handleClose} open={open}>
  ...
  const alertcDialogCodeString = `// AlertDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
  Open alert dialog
</Button>
...
<Box sx={{ p: 1, py: 1.5 }}>
  ...
  const formDialogCodeString = `// FormDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
  Open form dialog
</Button>
<Dialog open={open} onClose={handleClose}>
  ...
  const transitionsDialogCodeString = ` // TransitionsDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
  Slide in dialog
</Button>
<Dialog
...
>
  ...
  const customizedDialogCodeString = `// CustomizedDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
  Open dialog
</Button>
<BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
  ...
  const fullscreenDialogCodeString = `// FullScreenDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
...
<Dialog fullScreen open={open} onClose={handleClose} slots={{ transition: PopupTransition }}>
  ...
  const sizesDialogCodeString = `// SizesDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
...
<Dialog fullWidth={fullWidth} maxWidth={maxWidth} open={open} onClose={handleClose}>
  ...
  const responsiveDialogCodeString = `// ResponsiveDialog.jsx
<Button variant="contained" onClick={handleClickOpen}>
...
<Dialog open={open} onClose={handleClose} slots={{ paper: PaperComponent }} aria-labelledby="draggable-dialog-title">
  <Box sx={{ p: 1, py: 1.5 }}>
  ...
  const scrollingDialogCodeString = `// ScrollDialog.jsx
...
>
  ...
  const confirmDialogCodeString = `// ConfirmationDialog.jsx
