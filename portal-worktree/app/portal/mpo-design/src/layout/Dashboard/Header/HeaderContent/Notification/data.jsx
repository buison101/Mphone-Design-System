...
// Hoisted into functions so the sample content is rebuilt on every render.
// As module-scope constants these were evaluated once on import, which froze
// the first locale loaded. See docs/15 §4.7.
