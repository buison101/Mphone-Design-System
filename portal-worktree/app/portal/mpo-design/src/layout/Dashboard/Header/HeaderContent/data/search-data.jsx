...
// Hoisted into a function so the titles are rebuilt on every render.
// As a module-scope constant it was evaluated once on import, which froze the
// first locale loaded and left header search matching English only.
// See docs/15 §4.7.
