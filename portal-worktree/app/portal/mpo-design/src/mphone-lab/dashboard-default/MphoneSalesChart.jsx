...
export default function SalesChart({ filter = 'today', labels: textLabels = {} }) {
  ...
  const valueFormatter = (value) => `${textLabels.valuePrefix || '$'} ${value} ${textLabels.valueSuffix || 'Thousands'}`;
  ...
  const initialSeries = [
    { id: 'Income', data: incomeData, stack: 'income', label: textLabels.income || 'Income', color: warningColor, valueFormatter },
    { id: 'Income2', data: income2Data, stack: 'income', label: textLabels.income || 'Income', color: warningLightColor, valueFormatter },
    { id: 'CostOfSales', data: cosData, stack: 'cos', label: textLabels.cost || 'Cost of Sales', color: primaryColor, valueFormatter },
    {
      id: 'CostOfSales2',
      data: cos2Data,
      stack: 'cos',
      label: textLabels.cost || 'Cost of Sales',
...
SalesChart.propTypes = { filter: PropTypes.any, labels: PropTypes.object };
