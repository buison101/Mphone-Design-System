...
export default function OrderTable({ content = {} }) {
              ...
              return (
                ...
                >
                  ...
                  <TableCell align="right">
                    <NumericFormat value={row.protein} displayType="text" thousandSeparator prefix={content.currencyPrefix || '$'} />
                  </TableCell>
                </TableRow>
              );
            })}
...
OrderTable.propTypes = { content: PropTypes.object };
