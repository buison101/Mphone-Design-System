...
export default function UsersCardChart({ label = 'Users' }) {
  ...
  return (
    <BarChart
      hideLegend
      height={100}
      series={[{ data, label, color: withAlpha(theme.vars.palette.primary.main, 0.85) }]}
...
UsersCardChart.propTypes = { label: PropTypes.node };
