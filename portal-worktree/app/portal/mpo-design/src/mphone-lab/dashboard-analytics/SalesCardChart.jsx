...
export default function SalesCardChart({ label = 'Users' }) {
  ...
  return (
    <BarChart
      hideLegend
      height={100}
      series={[{ data, label, color: withAlpha(theme.vars.palette.warning.main, 0.85) }]}
...
SalesCardChart.propTypes = { label: PropTypes.node };
