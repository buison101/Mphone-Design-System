                ...
                <Grid container spacing={2} sx={(theme) => ({ [theme.breakpoints.down('md')]: { pr: 0, textAlign: 'center' } })}>
                  <Grid size={12}>
                    <SectionTypeset
                      ...
                      description="Whether you’re stuck or just have a question, we’re here to help you"
      ...
      >
        <ContainerWrapper>
          <Stack direction={{ xs: 'column', sm: 'row' }} sx={{ gap: 2, justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography variant="subtitle2" sx={{ textAlign: { xs: 'center', sm: 'left' }, color: 'secondary.main' }}>
