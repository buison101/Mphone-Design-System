...
| `src/layout/Dashboard/Header/HeaderContent/Customization/ColorScheme.jsx` | Renders only `default`, `theme1` and `theme4` | Product-owner customization decision: hide themes 2, 3, 5, 6, 7 and 8 | Reapply the `visibleColorOptions` allowlist before rendering |
